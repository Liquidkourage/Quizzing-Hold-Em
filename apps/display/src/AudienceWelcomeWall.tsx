 ...
 * Landscape full HD uses `!` dimensions and an absolute-pinned white tile; keep caps modest so neighbors
 * stay readable (dial with host feedback).
 */
